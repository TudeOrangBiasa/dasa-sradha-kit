...
| `/dasa-assimilate` | `dasa-assimilate.md` | **The Assimilation Protocol**: Run this on forked or undocumented codebases. It automatically detects your tech stack (including DDEV containers vs native NPM) and rewrites `dasa.config.yaml` to perfectly match the environment. |
